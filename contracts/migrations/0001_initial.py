    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_level', models.CharField(blank=True, max_length=5, choices=[('HS', 'High School'), (
                    'BA', 'Bachelors'), ('MA', 'Masters'), ('AA', 'Associates'), ('PHD', 'Ph.D.')], null=True)),
                ('min_years_experience', models.IntegerField()),
                ('hourly_rate_year1', models.DecimalField(
                ...
                ('search_index', djorm_pgfulltext.fields.VectorField(
                    serialize=False, default='', null=True, editable=False, db_index=True)),
            ],
            options={
            },
            bases=(models.Model,),
