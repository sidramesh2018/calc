...
All the static assets (SASS for CSS and ES6 JavaScript) are located in the [frontend/source/](frontend/source/) directory. Outputs from the gulp build are placed in directories within [frontend/static/frontend/built/](frontend/static/frontend/built/). Examine [gulpfile.js](gulpfile.js) for details of our gulp asset pipeline.
